    ...
    return (
        <>
            ...
            <div className="xsm:w-[85vw] w-[43.92386530014641vw] m-auto flex flex-col items-center">
                ...
                <input onKeyDown={(e) => { numericKeyBtnHandler(e) }} contentEditable className="w-[285px] h-[70px] !rounded-[0.3rem] border-[1px] border-black bg-[#e9ecef] text-[32px] indent-2" type={"text"} disabled defaultValue={code}></input>
