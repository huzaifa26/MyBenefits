...
export default function AddBenefitModel(props){
    ...
    return(
        <div className="absolute w-[100vw]">
            ...
            <div className="w-[600px] m-auto flex flex-col items-center relative z-20 bg-white rounded-[0.3rem]">
                ...
                <input className="w-[95%] h-[70px] !rounded-[0.3rem] border-[1px] border-black bg-[#e9ecef]" type={"text"} disabled value={code}></input>
                ...
                <div className="flex gap-[15px] py-[16px] text-[20px]">
                    <button onClick={()=>{props.closeModal()}} className="flex-1 border h-[51px] py-[8px] px-[16px] text-[#6c757d] border-[#6c757d]">Cancel</button>
