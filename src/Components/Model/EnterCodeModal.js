...
export default function EnterCodeModal(props){
    ...
    return(
        <div className="absolute w-[100vw]">
            ...
            <form ref={formRef} onSubmit={approveRequestSubmitHandler} className="w-[600px] m-auto flex flex-col items-start mt-[30px] relative z-20 bg-white rounded-[0.3rem]">
                <h2 className="font-medium pt-[5px] mb-[16px] text-[28px] p-[15px] text-[#0c5460] rounded-[0.25rem] w-[100%]  bg-[#d1ecf1] border border-[#bee5eb]">The details of the application must be verified and approved</h2>
                ...
                <div className="flex flex-col gap-[15px] px-[15px]">
                    ...
                    <div className="flex gap-[8px]">
                        <label className="font-medium text-[18px]">Ammount of points: </label><input className="h-[30px] border focus:shadow-md py-[6px] px-[12px]" required name="points"></input>
                    </div>
                </div>
