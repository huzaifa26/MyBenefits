                ...
                <form ref={brandInfoRef} onSubmit={brandInfoSubmitHandler} className="flex xsm:flex-col xsm:w-[100%] sm:flex-col sm:w-[100%] w-[80%] m-auto">
                    <div className="flex-1 flex flex-col gap-[1.03vh] xsm:w-[97%] w-[80%] m-auto pb-[1.62962962962963vh]">
                        ...
                        <div className="inline-block">
                            ...
                            <input type={"text"} name="openingHours" required placeholder="Opening Hours" className="openingHours indent-[15px] xsm:min-w-[280px] sm:min-w-[280px] w-[22.03513909224012vw] min-h-[30px] h-[5.555555555555555vh] max-h-[60px]" />
                        </div>
                        <div className="inline-block">
                            ...
                            <div className="relative flex">
                                <input type={"text"} name="specialOpeningHours" required placeholder="Special Opening Hours" className="specialOpening relative indent-[15px] xsm:min-w-[280px] sm:min-w-[280px] w-[22.03513909224012vw] min-h-[30px] h-[5.555555555555555vh] max-h-[60px]" />
