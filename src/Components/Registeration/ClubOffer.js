            ...
            <div className="flex items-center justify-center gap-[20px] max-w-[1920px] w-[calc(100vw - 100%)] h-[9.225vh] min-h-[70px] max-h-[99px]">
                ...
                <div className="flex justify-center items-center flex-1">
                    ...
                    <div className="flex gap-[4px]">
                        ...
                        <h2 className="text-[clamp(14px,1.2vw,24px)] flex items-center text-[#1D262D] font-bold">Choose Benefit</h2>
                    </div>
                    <span className="w-[37px] h-[2px] bg-[#707070] xsm:hidden sm:hidden"></span>
                    <div className="flex gap-[4px] xsm:hidden sm:hidden">
                        <span className="pt-[10px] border-[1px] border-[#1D262D] w-[46px] h-[44px] bg-[#fff] text-[15px] text-center rounded-full">3</span>
                        <h2 className="text-[clamp(14px,1.2vw,24px)] flex items-center text-[#1D262D] font-bold">Create Account</h2>
                    </div>
                </div>
            </div>
